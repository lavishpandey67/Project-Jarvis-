...
export const getRespondWithCompanionMutationKey = () => ['respondWithCompanion'] as const;

export const getRespondWithCompanionMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof respondWithCompanion>>, TError,RespondWithCompanionMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof respondWithCompanion>>, TError,RespondWithCompanionMutationVariables, TContext> => {

const mutationKey = getRespondWithCompanionMutationKey();
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof respondWithCompanion>>, RespondWithCompanionMutationVariables> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type RespondWithCompanionMutationVariables = {data: BodyType<CompanionRequest>}
...
export const useRespondWithCompanion = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof respondWithCompanion>>, TError,RespondWithCompanionMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
        ...
        TError,
        RespondWithCompanionMutationVariables,
        TContext
      > => {
      return useMutation(getRespondWithCompanionMutationOptions(options));
    }

export const getGetExecutionTraceUrl = (executionId: string,) => {
...
/**
 * @summary Get a durable Companion execution trace
 */
export const getExecutionTrace = async (executionId: string, options?: Parameters<typeof customFetch>[1]): Promise<ExecutionTrace> => {

  return customFetch<ExecutionTrace>(getGetExecutionTraceUrl(executionId),
  {
    ...options,
    method: 'GET'
...
export const getGetExecutionTraceQueryKey = (executionId: string,) => {
    return [
...
export const getGetExecutionTraceQueryOptions = <TData = Awaited<ReturnType<typeof getExecutionTrace>>, TError = ErrorType<void>>(executionId: string, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getExecutionTrace>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetExecutionTraceQueryKey(executionId);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getExecutionTrace>>> = ({ signal }) => getExecutionTrace(executionId, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: executionId !== null && executionId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getExecutionTrace>>, TError, TData> & { queryKey: QueryKey }
}

export type GetExecutionTraceQueryResult = NonNullable<Awaited<ReturnType<typeof getExecutionTrace>>>
export type GetExecutionTraceQueryError = ErrorType<void>
...
export function useGetExecutionTrace<TData = Awaited<ReturnType<typeof getExecutionTrace>>, TError = ErrorType<void>>(
 executionId: string, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getExecutionTrace>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetExecutionTraceQueryOptions(executionId,options)
...
export const getResumeExecutionUrl = (executionId: string,) => {




  return `/api/executions/${executionId}/resume`
}

/**
 * @summary Resume a non-terminal durable execution
 */
export const resumeExecution = async (executionId: string, options?: Parameters<typeof customFetch>[1]): Promise<CompanionResponse> => {

  return customFetch<CompanionResponse>(getResumeExecutionUrl(executionId),
  {
    ...options,
    method: 'POST'
...
export const getResumeExecutionMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof resumeExecution>>, TError,ResumeExecutionMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof resumeExecution>>, ResumeExecutionMutationVariables> = (props) => {
          ...
          return  resumeExecution(executionId,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type ResumeExecutionMutationError = ErrorType<void>
    export type ResumeExecutionMutationVariables = {executionId: string}

    /**
 * @summary Resume a non-terminal durable execution
 */
export const useResumeExecution = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof resumeExecution>>, TError,ResumeExecutionMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getResumeExecutionMutationOptions(options));
    }
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdateMemoryMutationVariables = {id: number;data: BodyType<MemoryUpdate>}
