...
export const RespondWithCompanionResponse = zod.object({
  ...
  "executionState": zod.enum(['PROPOSED', 'AUTHORIZED', 'EXECUTED', 'OBSERVED', 'EVALUATED', 'COMPLETED', 'FAILED', 'RECOVERING', 'ESCALATED']),
  "trace": zod.object({
  "journal": zod.record(zod.string(), zod.unknown()).nullable(),
  "graphs": zod.array(zod.record(zod.string(), zod.unknown())),
  "graph": zod.array(zod.record(zod.string(), zod.unknown())),
  ...
  "evaluations": zod.array(zod.record(zod.string(), zod.unknown())),
  "recoveries": zod.array(zod.record(zod.string(), zod.unknown())),
  "lessons": zod.array(zod.record(zod.string(), zod.unknown()))
})
})
 ...
 */
export const GetExecutionTraceParams = zod.object({
  "executionId": zod.coerce.string()
})

export const GetExecutionTraceResponse = zod.object({
  "journal": zod.record(zod.string(), zod.unknown()).nullable(),
  "graphs": zod.array(zod.record(zod.string(), zod.unknown())),
  "graph": zod.array(zod.record(zod.string(), zod.unknown())),
  "events": zod.array(zod.record(zod.string(), zod.unknown())),
 ...
 */
export const ResumeExecutionParams = zod.object({
  "executionId": zod.coerce.string()
})

export const ResumeExecutionResponse = zod.object({
  "conversationId": zod.number(),
  "userMessage": zod.object({
  "id": zod.number(),
  "conversationId": zod.number(),
